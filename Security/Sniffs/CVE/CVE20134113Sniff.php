<?php
namespace PHPCS_SecurityAudit\Security\Sniffs\CVE;
	...
	public function process(File $phpcsFile, $stackPtr) {
		...
		if ($tokens[$stackPtr]['content'] == 'xml_parse_into_struct') {
			...
			$s = $stackPtr + 1; // to skip the parenthesis opener '('
						$s = $phpcsFile->findNext(array_merge(\PHP_CodeSniffer\Util\Tokens::$emptyTokens, \PHPCS_SecurityAudit\Security\Sniffs\Utils::$staticTokens), $s + 1, $closer, true);
			if ($s) {
